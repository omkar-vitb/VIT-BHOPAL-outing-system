...
**step3** In the terminal type **swipl 02-main.pro**
**step4** start the system by typing **start.** (dont forget to add fullstop at last)
**step5** Answer the questions one by one:-
...
**step6** At last one can see the result whether they are qualified for outing or not

**step7** to stop the program type this command in terminal _halt._
